...
type AssetCreativeTemplateVariable_MimeType string

const (
	AssetCreativeTemplateVariable_MimeTypeJPG AssetCreativeTemplateVariable_MimeType = "JPG"

	AssetCreativeTemplateVariable_MimeTypePNG AssetCreativeTemplateVariable_MimeType = "PNG"

	AssetCreativeTemplateVariable_MimeTypeGIF AssetCreativeTemplateVariable_MimeType = "GIF"

	AssetCreativeTemplateVariable_MimeTypeSWF AssetCreativeTemplateVariable_MimeType = "SWF"
)
...
type CreativeTemplateStatus string
...
const (
	...
	//
	CreativeTemplateStatusACTIVE CreativeTemplateStatus = "ACTIVE"
	...
	//
	CreativeTemplateStatusINACTIVE CreativeTemplateStatus = "INACTIVE"

	//
	// The {@link CreativeTemplate} is deleted. Creatives created from this {@link CreativeTemplate}
	// can no longer serve.
	//
	CreativeTemplateStatusDELETED CreativeTemplateStatus = "DELETED"
)
...
type CreativeTemplateType string
...
const (
	...
	//
	CreativeTemplateTypeSYSTEM_DEFINED CreativeTemplateType = "SYSTEM_DEFINED"
	...
	//
	CreativeTemplateTypeUSER_DEFINED CreativeTemplateType = "USER_DEFINED"
)
...
type GetCreativeTemplatesByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 getCreativeTemplatesByStatement"`

	FilterStatement *Statement `xml:"filterStatement,omitempty" json:"filterStatement,omitempty"`
}

type GetCreativeTemplatesByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 getCreativeTemplatesByStatementResponse"`

	Rval *CreativeTemplatePage `xml:"rval,omitempty" json:"rval,omitempty"`
}
...
type AssetCreativeTemplateVariable struct {
	*CreativeTemplateVariable
	...
	//
	MimeTypes []*AssetCreativeTemplateVariable_MimeType `xml:"mimeTypes,omitempty" json:"mimeTypes,omitempty"`
}

type CreativeTemplate struct {

	//
	// Uniquely identifies the {@code CreativeTemplate}. This attribute is read-only and is assigned
	// by Google when a creative template is created.
	//
	Id int64 `xml:"id,omitempty" json:"id,omitempty"`

	//
	// The name of the creative template. This attribute is required and has a maximum length of 255
	// characters.
	//
	...
	//
	Variables []*CreativeTemplateVariable `xml:"variables,omitempty" json:"variables,omitempty"`

	//
	// The snippet of the creative template, with placeholders for the associated variables. This
	// attribute is required.
	//
	Snippet string `xml:"snippet,omitempty" json:"snippet,omitempty"`

	//
	// The status of the {@code CreativeTemplate}. This attribute is read-only and is assigned by
	// Google.
	//
	Status *CreativeTemplateStatus `xml:"status,omitempty" json:"status,omitempty"`

	//
	// The type of the {@code CreativeTemplate}. Publisher can only create user-defined template
	//
	Type_ *CreativeTemplateType `xml:"type,omitempty" json:"type,omitempty"`
...
type ListStringCreativeTemplateVariable struct {
	*StringCreativeTemplateVariable

	//
	// The values within the list users need to select from.
	//
	Choices []*ListStringCreativeTemplateVariable_VariableChoice `xml:"choices,omitempty" json:"choices,omitempty"`
	...
	//
	AllowOtherChoice bool `xml:"allowOtherChoice,omitempty" json:"allowOtherChoice,omitempty"`
}

type ListStringCreativeTemplateVariable_VariableChoice struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 ListStringCreativeTemplateVariable.VariableChoice"`

	//
	// Label that users can select from. This is displayed to users when creating a
	// {@link TemplateCreative}. This attribute is intended to be more descriptive than
	// {@link #value}. This attribute is required and has a maximum length of 255 characters.
	//
	Label string `xml:"label,omitempty" json:"label,omitempty"`

	//
	// Value that users can select from. When creating a {@link TemplateCreative}, the value in
	// {@link StringCreativeTemplateVariableValue} should match this value, if you intend to
...
type LongCreativeTemplateVariable struct {
	*CreativeTemplateVariable
	...
	// template.
	//
	DefaultValue int64 `xml:"defaultValue,omitempty" json:"defaultValue,omitempty"`
}
...
type CreativeTemplatePage struct {
	...
	//
	Results []*CreativeTemplate `xml:"results,omitempty" json:"results,omitempty"`
}

type StringCreativeTemplateVariable struct {
	*CreativeTemplateVariable
...
type UrlCreativeTemplateVariable struct {
	*CreativeTemplateVariable
	...
	//
	IsTrackingUrl bool `xml:"isTrackingUrl,omitempty" json:"isTrackingUrl,omitempty"`
}

type CreativeTemplateVariable struct {

	//
	// Label that is displayed to users when creating {@link TemplateCreative} from the
	// {@link CreativeTemplate}. This attribute is required and has a maximum
	...
	//
	// {@code true} if this variable is required to be filled in by users when
	// creating {@link TemplateCreative} from the {@link CreativeTemplate}.
	//
...
type CreativeTemplateServiceInterface interface {
	...
	*/
	GetCreativeTemplatesByStatement(request *GetCreativeTemplatesByStatement) (*GetCreativeTemplatesByStatementResponse, error)

	GetCreativeTemplatesByStatementContext(ctx context.Context, request *GetCreativeTemplatesByStatement) (*GetCreativeTemplatesByStatementResponse, error)
}

type creativeTemplateServiceInterface struct {
	client *soap.Client
}

func NewCreativeTemplateServiceInterface(client *soap.Client) CreativeTemplateServiceInterface {
	return &creativeTemplateServiceInterface{
		client: client,
	}
}

func (service *creativeTemplateServiceInterface) GetCreativeTemplatesByStatementContext(ctx context.Context, request *GetCreativeTemplatesByStatement) (*GetCreativeTemplatesByStatementResponse, error) {
	response := new(GetCreativeTemplatesByStatementResponse)
...
func (service *creativeTemplateServiceInterface) GetCreativeTemplatesByStatement(request *GetCreativeTemplatesByStatement) (*GetCreativeTemplatesByStatementResponse, error) {
	return service.GetCreativeTemplatesByStatementContext(
		context.Background(),
		request,
	)
}
