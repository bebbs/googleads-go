...
type CreateLineItems struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 createLineItems"`

	LineItems []*LineItem `xml:"lineItems,omitempty" json:"lineItems,omitempty"`
}

type CreateLineItemsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 createLineItemsResponse"`
...
type GetLineItemsByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 getLineItemsByStatement"`
...
type GetLineItemsByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 getLineItemsByStatementResponse"`

	Rval *LineItemPage `xml:"rval,omitempty" json:"rval,omitempty"`
}

type PerformLineItemAction struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 performLineItemAction"`
...
type PerformLineItemActionResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 performLineItemActionResponse"`

	Rval *UpdateResult `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdateLineItems struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 updateLineItems"`

	LineItems []*LineItem `xml:"lineItems,omitempty" json:"lineItems,omitempty"`
}

type UpdateLineItemsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 updateLineItemsResponse"`
