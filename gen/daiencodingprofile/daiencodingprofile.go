...
type daiEncodingProfileServiceInterface struct {
	client *soap.Client
}

func NewDaiEncodingProfileServiceInterface(client *soap.Client) DaiEncodingProfileServiceInterface {
	return &daiEncodingProfileServiceInterface{
		client: client,
	}
}

func (service *daiEncodingProfileServiceInterface) CreateDaiEncodingProfilesContext(ctx context.Context, request *CreateDaiEncodingProfiles) (*CreateDaiEncodingProfilesResponse, error) {
	response := new(CreateDaiEncodingProfilesResponse)
...
func (service *daiEncodingProfileServiceInterface) CreateDaiEncodingProfiles(request *CreateDaiEncodingProfiles) (*CreateDaiEncodingProfilesResponse, error) {
	return service.CreateDaiEncodingProfilesContext(
		context.Background(),
		request,
	)
}

func (service *daiEncodingProfileServiceInterface) GetDaiEncodingProfilesByStatementContext(ctx context.Context, request *GetDaiEncodingProfilesByStatement) (*GetDaiEncodingProfilesByStatementResponse, error) {
	response := new(GetDaiEncodingProfilesByStatementResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *daiEncodingProfileServiceInterface) GetDaiEncodingProfilesByStatement(request *GetDaiEncodingProfilesByStatement) (*GetDaiEncodingProfilesByStatementResponse, error) {
	return service.GetDaiEncodingProfilesByStatementContext(
		context.Background(),
		request,
	)
}

func (service *daiEncodingProfileServiceInterface) PerformDaiEncodingProfileActionContext(ctx context.Context, request *PerformDaiEncodingProfileAction) (*PerformDaiEncodingProfileActionResponse, error) {
	response := new(PerformDaiEncodingProfileActionResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *daiEncodingProfileServiceInterface) PerformDaiEncodingProfileAction(request *PerformDaiEncodingProfileAction) (*PerformDaiEncodingProfileActionResponse, error) {
	return service.PerformDaiEncodingProfileActionContext(
		context.Background(),
		request,
	)
}

func (service *daiEncodingProfileServiceInterface) UpdateDaiEncodingProfilesContext(ctx context.Context, request *UpdateDaiEncodingProfiles) (*UpdateDaiEncodingProfilesResponse, error) {
	response := new(UpdateDaiEncodingProfilesResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *daiEncodingProfileServiceInterface) UpdateDaiEncodingProfiles(request *UpdateDaiEncodingProfiles) (*UpdateDaiEncodingProfilesResponse, error) {
	return service.UpdateDaiEncodingProfilesContext(
		context.Background(),
		request,
	)
}
