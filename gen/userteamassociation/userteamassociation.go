...
type CreateUserTeamAssociations struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 createUserTeamAssociations"`

	UserTeamAssociations []*UserTeamAssociation `xml:"userTeamAssociations,omitempty" json:"userTeamAssociations,omitempty"`
}

type CreateUserTeamAssociationsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 createUserTeamAssociationsResponse"`

	Rval []*UserTeamAssociation `xml:"rval,omitempty" json:"rval,omitempty"`
}

type ApiExceptionFault ApiException

type GetUserTeamAssociationsByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 getUserTeamAssociationsByStatement"`

	FilterStatement *Statement `xml:"filterStatement,omitempty" json:"filterStatement,omitempty"`
}

type GetUserTeamAssociationsByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 getUserTeamAssociationsByStatementResponse"`

	Rval *UserTeamAssociationPage `xml:"rval,omitempty" json:"rval,omitempty"`
}

type PerformUserTeamAssociationAction struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 performUserTeamAssociationAction"`

	UserTeamAssociationAction *UserTeamAssociationAction `xml:"userTeamAssociationAction,omitempty" json:"userTeamAssociationAction,omitempty"`

	Statement *Statement `xml:"statement,omitempty" json:"statement,omitempty"`
}

type PerformUserTeamAssociationActionResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 performUserTeamAssociationActionResponse"`

	Rval *UpdateResult `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdateUserTeamAssociations struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 updateUserTeamAssociations"`

	UserTeamAssociations []*UserTeamAssociation `xml:"userTeamAssociations,omitempty" json:"userTeamAssociations,omitempty"`
}

type UpdateUserTeamAssociationsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 updateUserTeamAssociationsResponse"`
...
type DeleteUserTeamAssociations struct {
...
type UserRecordTeamAssociation struct {

	//
	// The {@link Team#id} of the team.
	//
	TeamId int64 `xml:"teamId,omitempty" json:"teamId,omitempty"`

	//
	// The overridden team access type. This field is {@code null} if team access type is not
	// overridden.
	//
	OverriddenTeamAccessType *TeamAccessType `xml:"overriddenTeamAccessType,omitempty" json:"overriddenTeamAccessType,omitempty"`

	//
	// The default team access type {@link Team#teamAccessType}. This field is read-only and is
	// populated by Google.
	//
	DefaultTeamAccessType *TeamAccessType `xml:"defaultTeamAccessType,omitempty" json:"defaultTeamAccessType,omitempty"`
}

type UserTeamAssociationAction struct {
}
...
type UserTeamAssociationPage struct {
	...
	//
	Results []*UserTeamAssociation `xml:"results,omitempty" json:"results,omitempty"`
}

type _Value struct {
}

type UserTeamAssociationServiceInterface interface {
	...
	*/
	CreateUserTeamAssociations(request *CreateUserTeamAssociations) (*CreateUserTeamAssociationsResponse, error)

	CreateUserTeamAssociationsContext(ctx context.Context, request *CreateUserTeamAssociations) (*CreateUserTeamAssociationsResponse, error)
	...
	*/
	GetUserTeamAssociationsByStatement(request *GetUserTeamAssociationsByStatement) (*GetUserTeamAssociationsByStatementResponse, error)

	GetUserTeamAssociationsByStatementContext(ctx context.Context, request *GetUserTeamAssociationsByStatement) (*GetUserTeamAssociationsByStatementResponse, error)
	...
	/*
	   ...
	   Statement#query}.
	*/
	PerformUserTeamAssociationAction(request *PerformUserTeamAssociationAction) (*PerformUserTeamAssociationActionResponse, error)

	PerformUserTeamAssociationActionContext(ctx context.Context, request *PerformUserTeamAssociationAction) (*PerformUserTeamAssociationActionResponse, error)
	...
	*/
	UpdateUserTeamAssociations(request *UpdateUserTeamAssociations) (*UpdateUserTeamAssociationsResponse, error)

	UpdateUserTeamAssociationsContext(ctx context.Context, request *UpdateUserTeamAssociations) (*UpdateUserTeamAssociationsResponse, error)
}

type userTeamAssociationServiceInterface struct {
	client *soap.Client
}

func NewUserTeamAssociationServiceInterface(client *soap.Client) UserTeamAssociationServiceInterface {
	return &userTeamAssociationServiceInterface{
		client: client,
	}
}

func (service *userTeamAssociationServiceInterface) CreateUserTeamAssociationsContext(ctx context.Context, request *CreateUserTeamAssociations) (*CreateUserTeamAssociationsResponse, error) {
	response := new(CreateUserTeamAssociationsResponse)
...
func (service *userTeamAssociationServiceInterface) CreateUserTeamAssociations(request *CreateUserTeamAssociations) (*CreateUserTeamAssociationsResponse, error) {
	return service.CreateUserTeamAssociationsContext(
		context.Background(),
		request,
	)
}

func (service *userTeamAssociationServiceInterface) GetUserTeamAssociationsByStatementContext(ctx context.Context, request *GetUserTeamAssociationsByStatement) (*GetUserTeamAssociationsByStatementResponse, error) {
	response := new(GetUserTeamAssociationsByStatementResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *userTeamAssociationServiceInterface) GetUserTeamAssociationsByStatement(request *GetUserTeamAssociationsByStatement) (*GetUserTeamAssociationsByStatementResponse, error) {
	return service.GetUserTeamAssociationsByStatementContext(
		context.Background(),
		request,
	)
}

func (service *userTeamAssociationServiceInterface) PerformUserTeamAssociationActionContext(ctx context.Context, request *PerformUserTeamAssociationAction) (*PerformUserTeamAssociationActionResponse, error) {
	response := new(PerformUserTeamAssociationActionResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *userTeamAssociationServiceInterface) PerformUserTeamAssociationAction(request *PerformUserTeamAssociationAction) (*PerformUserTeamAssociationActionResponse, error) {
	return service.PerformUserTeamAssociationActionContext(
		context.Background(),
		request,
	)
}

func (service *userTeamAssociationServiceInterface) UpdateUserTeamAssociationsContext(ctx context.Context, request *UpdateUserTeamAssociations) (*UpdateUserTeamAssociationsResponse, error) {
	response := new(UpdateUserTeamAssociationsResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *userTeamAssociationServiceInterface) UpdateUserTeamAssociations(request *UpdateUserTeamAssociations) (*UpdateUserTeamAssociationsResponse, error) {
	return service.UpdateUserTeamAssociationsContext(
		context.Background(),
		request,
	)
}
