...
type targetingPresetServiceInterface struct {
	client *soap.Client
}

func NewTargetingPresetServiceInterface(client *soap.Client) TargetingPresetServiceInterface {
	return &targetingPresetServiceInterface{
		client: client,
	}
}

func (service *targetingPresetServiceInterface) GetTargetingPresetsByStatementContext(ctx context.Context, request *GetTargetingPresetsByStatement) (*GetTargetingPresetsByStatementResponse, error) {
	response := new(GetTargetingPresetsByStatementResponse)
...
func (service *targetingPresetServiceInterface) GetTargetingPresetsByStatement(request *GetTargetingPresetsByStatement) (*GetTargetingPresetsByStatementResponse, error) {
	return service.GetTargetingPresetsByStatementContext(
		context.Background(),
		request,
	)
}
