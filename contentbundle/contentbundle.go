...
type ContentBundleStatus string
...
const (
	...
	//
	ContentBundleStatusACTIVE ContentBundleStatus = "ACTIVE"

	//
	// The object is no longer active and no stats collected.
	//
	ContentBundleStatusINACTIVE ContentBundleStatus = "INACTIVE"

	//
	// The object has been archived.
	//
	ContentBundleStatusARCHIVED ContentBundleStatus = "ARCHIVED"

	//
	// The value returned if the actual value is not exposed by the requested API version.
	//
	ContentBundleStatusUNKNOWN ContentBundleStatus = "UNKNOWN"
)

//
// The reasons for the {@link ContentFilterError}.
//

type ContentFilterError_Reason string
...
const (
	...
	// The value returned if the actual value is not exposed by the requested API version.
	//
	ContentFilterError_ReasonUNKNOWN ContentFilterError_Reason = "UNKNOWN"

	ContentFilterError_ReasonWRONG_NUMBER_OF_ARGUMENTS ContentFilterError_Reason = "WRONG_NUMBER_OF_ARGUMENTS"

	ContentFilterError_ReasonANY_FILTER_NOT_SUPPORTED ContentFilterError_Reason = "ANY_FILTER_NOT_SUPPORTED"
)
...
type CreateContentBundles struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 createContentBundles"`

	ContentBundles []*ContentBundle `xml:"contentBundles,omitempty" json:"contentBundles,omitempty"`
}

type CreateContentBundlesResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 createContentBundlesResponse"`

	Rval []*ContentBundle `xml:"rval,omitempty" json:"rval,omitempty"`
}

type ApiExceptionFault ApiException

type GetContentBundlesByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 getContentBundlesByStatement"`

	FilterStatement *Statement `xml:"filterStatement,omitempty" json:"filterStatement,omitempty"`
}

type GetContentBundlesByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 getContentBundlesByStatementResponse"`

	Rval *ContentBundlePage `xml:"rval,omitempty" json:"rval,omitempty"`
}

type PerformContentBundleAction struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 performContentBundleAction"`

	ContentBundleAction *ContentBundleAction `xml:"contentBundleAction,omitempty" json:"contentBundleAction,omitempty"`

	FilterStatement *Statement `xml:"filterStatement,omitempty" json:"filterStatement,omitempty"`
}

type PerformContentBundleActionResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 performContentBundleActionResponse"`

	Rval *UpdateResult `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdateContentBundles struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 updateContentBundles"`

	ContentBundles []*ContentBundle `xml:"contentBundles,omitempty" json:"contentBundles,omitempty"`
}

type UpdateContentBundlesResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 updateContentBundlesResponse"`
...
type ActivateContentBundles struct {
	*ContentBundleAction
}
...
type ContentBundleAction struct {
}

type ContentBundle struct {

	//
	// ID that uniquely identifies the {@code ContentBundle}. This attribute is read-only and is
	// assigned by Google when a content bundle is created.
	//
	Id int64 `xml:"id,omitempty" json:"id,omitempty"`

	//
	// The name of the {@code ContentBundle}. This attribute is required and has a maximum length of
	// 255 characters.
	//
	Name string `xml:"name,omitempty" json:"name,omitempty"`

	//
	// The {@link ContentBundleStatus} of the {@code ContentBundle}. This attribute is read-only and
	// defaults to {@link ContentBundleStatus#INACTIVE}.
	//
	Status *ContentBundleStatus `xml:"status,omitempty" json:"status,omitempty"`
...
type ContentBundlePage struct {
	...
	//
	Results []*ContentBundle `xml:"results,omitempty" json:"results,omitempty"`
}

type ContentFilterError struct {
	*ApiError

	Reason *ContentFilterError_Reason `xml:"reason,omitempty" json:"reason,omitempty"`
}
...
type DeactivateContentBundles struct {
	*ContentBundleAction
}
...
type ContentBundleServiceInterface interface {
	...
	*/
	CreateContentBundles(request *CreateContentBundles) (*CreateContentBundlesResponse, error)

	CreateContentBundlesContext(ctx context.Context, request *CreateContentBundles) (*CreateContentBundlesResponse, error)
	...
	*/
	GetContentBundlesByStatement(request *GetContentBundlesByStatement) (*GetContentBundlesByStatementResponse, error)

	GetContentBundlesByStatementContext(ctx context.Context, request *GetContentBundlesByStatement) (*GetContentBundlesByStatementResponse, error)
	...
	*/
	PerformContentBundleAction(request *PerformContentBundleAction) (*PerformContentBundleActionResponse, error)

	PerformContentBundleActionContext(ctx context.Context, request *PerformContentBundleAction) (*PerformContentBundleActionResponse, error)
	...
	*/
	UpdateContentBundles(request *UpdateContentBundles) (*UpdateContentBundlesResponse, error)

	UpdateContentBundlesContext(ctx context.Context, request *UpdateContentBundles) (*UpdateContentBundlesResponse, error)
}

type contentBundleServiceInterface struct {
	client *soap.Client
}

func NewContentBundleServiceInterface(client *soap.Client) ContentBundleServiceInterface {
	return &contentBundleServiceInterface{
		client: client,
	}
}

func (service *contentBundleServiceInterface) CreateContentBundlesContext(ctx context.Context, request *CreateContentBundles) (*CreateContentBundlesResponse, error) {
	response := new(CreateContentBundlesResponse)
...
func (service *contentBundleServiceInterface) CreateContentBundles(request *CreateContentBundles) (*CreateContentBundlesResponse, error) {
	return service.CreateContentBundlesContext(
		context.Background(),
		request,
	)
}

func (service *contentBundleServiceInterface) GetContentBundlesByStatementContext(ctx context.Context, request *GetContentBundlesByStatement) (*GetContentBundlesByStatementResponse, error) {
	response := new(GetContentBundlesByStatementResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *contentBundleServiceInterface) GetContentBundlesByStatement(request *GetContentBundlesByStatement) (*GetContentBundlesByStatementResponse, error) {
	return service.GetContentBundlesByStatementContext(
		context.Background(),
		request,
	)
}

func (service *contentBundleServiceInterface) PerformContentBundleActionContext(ctx context.Context, request *PerformContentBundleAction) (*PerformContentBundleActionResponse, error) {
	response := new(PerformContentBundleActionResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *contentBundleServiceInterface) PerformContentBundleAction(request *PerformContentBundleAction) (*PerformContentBundleActionResponse, error) {
	return service.PerformContentBundleActionContext(
		context.Background(),
		request,
	)
}

func (service *contentBundleServiceInterface) UpdateContentBundlesContext(ctx context.Context, request *UpdateContentBundles) (*UpdateContentBundlesResponse, error) {
	response := new(UpdateContentBundlesResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *contentBundleServiceInterface) UpdateContentBundles(request *UpdateContentBundles) (*UpdateContentBundlesResponse, error) {
	return service.UpdateContentBundlesContext(
		context.Background(),
		request,
	)
}
