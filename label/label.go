...
const (
	...
	// the same page.
	//
	LabelTypeCOMPETITIVE_EXCLUSION LabelType = "COMPETITIVE_EXCLUSION"
	...
	//
	LabelTypeCREATIVE_WRAPPER LabelType = "CREATIVE_WRAPPER"
	...
	//
	LabelTypeCANONICAL_CATEGORY LabelType = "CANONICAL_CATEGORY"
...
type CreateLabels struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 createLabels"`

	Labels []*Label `xml:"labels,omitempty" json:"labels,omitempty"`
}

type CreateLabelsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 createLabelsResponse"`

	Rval []*Label `xml:"rval,omitempty" json:"rval,omitempty"`
}

type ApiExceptionFault ApiException

type GetLabelsByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 getLabelsByStatement"`

	FilterStatement *Statement `xml:"filterStatement,omitempty" json:"filterStatement,omitempty"`
}

type GetLabelsByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 getLabelsByStatementResponse"`

	Rval *LabelPage `xml:"rval,omitempty" json:"rval,omitempty"`
}

type PerformLabelAction struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 performLabelAction"`

	LabelAction *LabelAction `xml:"labelAction,omitempty" json:"labelAction,omitempty"`

	FilterStatement *Statement `xml:"filterStatement,omitempty" json:"filterStatement,omitempty"`
}

type PerformLabelActionResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 performLabelActionResponse"`

	Rval *UpdateResult `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdateLabels struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 updateLabels"`

	Labels []*Label `xml:"labels,omitempty" json:"labels,omitempty"`
}

type UpdateLabelsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202311 updateLabelsResponse"`
...
type ActivateLabels struct {
	*LabelAction
}

type AdCategoryDto struct {
...
type Label struct {
	...
	//
	// Unique ID of the {@code Label}. This value is readonly and is assigned by Google.
	//
	Id int64 `xml:"id,omitempty" json:"id,omitempty"`

	//
	// Name of the {@code Label}. This is value is required to create a label and has a maximum length
	// of 127 characters.
	//
	...
	//
	AdCategory *AdCategoryDto `xml:"adCategory,omitempty" json:"adCategory,omitempty"`

	//
	// The types of the {@code Label}.
	//
	Types []*LabelType `xml:"types,omitempty" json:"types,omitempty"`
}
...
type LabelPage struct {
	...
	//
	Results []*Label `xml:"results,omitempty" json:"results,omitempty"`
}
...
type LabelServiceInterface interface {
	...
	*/
	CreateLabels(request *CreateLabels) (*CreateLabelsResponse, error)

	CreateLabelsContext(ctx context.Context, request *CreateLabels) (*CreateLabelsResponse, error)
	...
	*/
	GetLabelsByStatement(request *GetLabelsByStatement) (*GetLabelsByStatementResponse, error)

	GetLabelsByStatementContext(ctx context.Context, request *GetLabelsByStatement) (*GetLabelsByStatementResponse, error)
	...
	*/
	PerformLabelAction(request *PerformLabelAction) (*PerformLabelActionResponse, error)

	PerformLabelActionContext(ctx context.Context, request *PerformLabelAction) (*PerformLabelActionResponse, error)
	...
	*/
	UpdateLabels(request *UpdateLabels) (*UpdateLabelsResponse, error)

	UpdateLabelsContext(ctx context.Context, request *UpdateLabels) (*UpdateLabelsResponse, error)
}
...
func NewLabelServiceInterface(client *soap.Client) LabelServiceInterface {
	return &labelServiceInterface{
		client: client,
	}
}

func (service *labelServiceInterface) CreateLabelsContext(ctx context.Context, request *CreateLabels) (*CreateLabelsResponse, error) {
	response := new(CreateLabelsResponse)
...
func (service *labelServiceInterface) CreateLabels(request *CreateLabels) (*CreateLabelsResponse, error) {
	return service.CreateLabelsContext(
		context.Background(),
		request,
	)
}

func (service *labelServiceInterface) GetLabelsByStatementContext(ctx context.Context, request *GetLabelsByStatement) (*GetLabelsByStatementResponse, error) {
	response := new(GetLabelsByStatementResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *labelServiceInterface) GetLabelsByStatement(request *GetLabelsByStatement) (*GetLabelsByStatementResponse, error) {
	return service.GetLabelsByStatementContext(
		context.Background(),
		request,
	)
}

func (service *labelServiceInterface) PerformLabelActionContext(ctx context.Context, request *PerformLabelAction) (*PerformLabelActionResponse, error) {
	response := new(PerformLabelActionResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *labelServiceInterface) PerformLabelAction(request *PerformLabelAction) (*PerformLabelActionResponse, error) {
	return service.PerformLabelActionContext(
		context.Background(),
		request,
	)
}

func (service *labelServiceInterface) UpdateLabelsContext(ctx context.Context, request *UpdateLabels) (*UpdateLabelsResponse, error) {
	response := new(UpdateLabelsResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *labelServiceInterface) UpdateLabels(request *UpdateLabels) (*UpdateLabelsResponse, error) {
	return service.UpdateLabelsContext(
		context.Background(),
		request,
	)
}
